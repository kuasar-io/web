...
type: docs
---
**Note :** This document keeps changing based on the status and feedback of Kuasar Community.

This document gives a brief overview of the Kuasar community roles with the requirements and responsibilities associated with them.

| Role | Requirements | Responsibilities | Privileges |
| -----| ---------------- | ------------ | -------|
| [Member](#member) | Sponsor from 2 approvers, active in community, contributed to Kuasar | Welcome and guide new contributors | Kuasar GitHub organization Member |
...
| [Owner](#owner) | Sponsor from 3 owners, helps drive the overall Kuasar project | Drive the overall technical roadmap of the project and set priorities of activities in release planning | Kuasar GitHub organization Admin access |

**Note :** It is mandatory for all Kuasar community members to follow Kuasar [Code of Conduct].
...
- Actively contributed to the community. Contributions may include, but are not limited to:
    ...
    - Participate in Kuasar community meetings


### Responsibilities and privileges

- Member of the Kuasar GitHub organization
...
- Help/Motivate new members in contributing to Kuasar
...
- Continue to contribute and guide other community members to contribute in Kuasar project
...
- Analyze and propose new features/enhancements in Kuasar project
...
Has deep understanding of Kuasar and related domain and facilitates major agreement in release planning
...
**Note :** These roles are applicable only for Kuasar github organization and repositories. Currently Kuasar doesn't have a formal process for review and acceptance into these roles. We will come-up with a process soon.
